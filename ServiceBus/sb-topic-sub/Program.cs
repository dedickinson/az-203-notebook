...
namespace sb_topic_sub
{
    class Program
    {
        ...
        private static readonly string SubscriptionName = Environment.GetEnvironmentVariable(ENV_SUBSCRIPTION);
        ...
        static async Task<int> Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Please set {ENV_SUBSCRIPTION} in your environment");
                return 1;
            }
